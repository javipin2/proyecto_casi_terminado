...
class SuperuserDetallesReservas extends StatefulWidget {
  ...
  const SuperuserDetallesReservas({super.key, required this.reserva});

  @override
  SuperuserDetallesReservasState createState() => SuperuserDetallesReservasState();
}

class SuperuserDetallesReservasState extends State<SuperuserDetallesReservas>
